...
#hash birhtday conffustion
from math import log, sqrt
p = 0.75
H = 2**11

print(sqrt(2*H*log(1/(1-p))))
...
print(i)
io.send(json.dumps({'m1': "0101010101010101010101010101010101010101010101010101010101010101", 'm2': "01010101010101010101010101010101010101010101010101010101010101"}).encode())
i = io.recv()
print(i)
